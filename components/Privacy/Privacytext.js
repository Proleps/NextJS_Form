export const PrivacyText = () => (
  <>
    ...
    <br/><br/>
    <div>2. Основные понятия, используемые в Политике</div>
    ...
    <br/><br/>
    <div>3. Оператор может обрабатывать следующие персональные данные Пользователя</div>
    ...
    <br/><br/>
    <div>4. Цели обработки персональных данных</div>
    ...
    <br/><br/>
    <div>5. Правовые основания обработки персональных данных</div>
    ...
    <br/><br/>
    <div>6. Порядок сбора, хранения, передачи и других видов обработки персональных данных</div>
    ...
    <br/>8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу httpsː//thismywebsite·com/privacy/.
  </>
)